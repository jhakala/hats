...
// Fri Mar 17 19:27:45 2017 by ROOT version 6.06/01
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("hatsSamples/sigFile1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("hatsSamples/sigFile1.root");
      }
