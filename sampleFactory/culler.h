...
// Fri Mar 17 15:20:01 2017 by ROOT version 6.06/01
// from TTree tree/tree
// found on file: sigs/sig_QCD_HT1000to1500_0_0.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     Loop(std::string sampleOutName, long max);
...
#ifdef culler_cxx
culler::culler(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("sigs/sig_QCD_HT1000to1500_0_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("sigs/sig_QCD_HT1000to1500_0_0.root");
      }
...
Int_t culler::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t culler::LoadTree(Long64_t entry)
{
...
void culler::Show(Long64_t entry)
{
...
Int_t culler::Cut(Long64_t entry)
{
